...
parser.add_argument('--load_dir', type=str, default='./BiLSTM_case_study/best_model.pt', help='Root dir for saving models.')
...
parser.add_argument("--dim_deprel", type=int, default=30, help="Deprel embedding dimension")
